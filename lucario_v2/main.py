...
# --- BULLETPROOF DECK LOADER ---
deck_path = None
if os.path.exists("/kaggle_simulations/agent/deck.csv"):
    deck_path = "/kaggle_simulations/agent/deck.csv"
elif os.path.exists("lucario_test/deck.csv"):
    deck_path = "lucario_test/deck.csv"
elif os.path.exists("deck.csv"):
    deck_path = "deck.csv"
...
# Decklist
# ... (The rest of your Makuhita, Hariyama variables and code stay the same)
