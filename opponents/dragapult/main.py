...
from cg.api import AreaType, CardType, EnergyType, Observation, SelectContext, OptionType, Card, Pokemon, all_card_data, to_observation_class, Log, LogType

# --- UNIVERSAL DECK LOADER ---
deck_path = None

# 1. Check Kaggle's cloud submission environment
# --- FOOLPROOF DECK LOADER ---
if os.path.exists("/kaggle_simulations/agent/deck.csv"):
    deck_path = "/kaggle_simulations/agent/deck.csv"
else:
    deck_path = "opponents/dragapult/deck.csv"

if deck_path is None:
    raise FileNotFoundError("CRITICAL ERROR: Cannot find deck.csv anywhere!")

# Read the file and convert the IDs to integers for my_deck
